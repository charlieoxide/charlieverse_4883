  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'xl': 'var(--shadow-xl)',
        '2xl': 'var(--shadow-2xl)',
        'blue': '0 4px 20px rgba(0, 102, 255, 0.15)',
        'blue-lg': '0 10px 30px rgba(0, 102, 255, 0.2)',
      ...
      keyframes: {
        ...
        "glow": {
          from: { boxShadow: "0 0 20px rgba(0, 102, 255, 0.2)" },
          to: { boxShadow: "0 0 30px rgba(0, 102, 255, 0.4)" },
        },
        "pulseBlue": {
          "0%, 100%": { opacity: "1" },
          "50%": { opacity: "0.5" },
